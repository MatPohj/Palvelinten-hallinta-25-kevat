...
Lähdin tekemään tätä tehtävää Teron `[Hello Ansible](https://terokarvinen.com/hello-ansible/)` -artikkelin mukaan. Asensin Ansiblen ja testasin ``ansible -h`` jotta näkisin asentuiko ansible oikein. 
...
Tuli errori. Hetken katsottuani huomasin, että olin laittanut tiedoston himeksi host.ini enkä hosts.ini. Korjasin typon ja suoritin komennon uudestaan. 
