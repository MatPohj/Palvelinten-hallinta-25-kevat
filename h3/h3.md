...
Tämän jälkeen tein public.html kansioon tiedoston index.html.
...
Asensin nginx `sudo apt isntall nginx` ja samalla sammutin apachen, jotta se ei häiritse nginx tointaa `sudo systemctl stop apache2`
...
Tein uuden website tiedoston, pohjana toimi ubuntun tutoriaalista otettu malli.
...
# Lähteet
- Gemini 3 Pro
- Karvinen 2026: [Apache installed with Ansible - quick notes](https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_handlers.html)
- Ansible Community Documentation: [Handlers: running operations on change](https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_handlers.html)
- Ansible docs, ansible-doc service
