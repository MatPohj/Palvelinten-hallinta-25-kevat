...
## g
> Vapaaehtoinen: Se toinen järjestelmä: kokeile Gittiä eri käyttöjärjestelmällä kuin sillä, millä teit muut harjoitukset. Selitä niin, että kyseistä järjestelmää osaamatonkin onnistuu. Mahdollisuuksia on runsaasti: Debian, Fedora, Windows, OSX...
...
Tuli errori, joka todennäköisesti johtui remote repositorysta, eli netissä olevassa repositoryssa olevista tiedostoista. Seuraavaksi koitin pullata nämä.
...
Tai ainaskin niin luulin. Tämä lisäsi tämän ns "submodulena" eli se viittaisi toiseen repositoryyn. Koska tätä ansible repositorya ei ole, ei tätä kansiota saa avattua.
